...
Sub LoadPinGoVpController
	'On Error Resume Next
		...
		ExecuteGlobal GetTextFile("PinGod_PROC_PDB.vbs")
...
'get neutral color of light
'msgbox Light005.color
...
Dim TroughSwitches,bsTrough:TroughSwitches = Array(12,13,14,15)
...
SolCallback(5) = "bsTrough.solOut" ' This exit is setup in the init
'SolCallback(42) = "FlippersEnabled"
'SolCallback(43) = "AutoPlunger"
'SolCallback(44) = "bsSaucer.solOut" ' This exit is setup in the init
...
Sub PinGodAlive(Enabled)
	...
	If enabled = True then
		...
		'MsgBox "Game window ready."
		'if not initialized Then InitGame : End If
	Else
...
Sub TroughEject(Enabled)
	if Enabled Then bsTrough.solOut Enabled: End If
	Debug.Print "TroughEject:" & Enabled
End Sub
