...
/// Sends <see cref="PinGodBase.BonusEndedEventHandler"/> signal on <see cref="_display_for_seconds"/> timeout
/// </summary>
public partial class Bonus : Control
{
    ...
    /// <summary>
    /// Stops the timer and emits the <see cref="PinGodBase.BonusEndedEventHandler"/>
    /// </summary>
    public virtual void OnTimedOut()
    {
        ...
        timer.Stop();
        this.Visible = false;
        pinGod.EmitSignal(nameof(PinGodBase.BonusEndedEventHandler));
    }
	...
	/// <summary>
	/// Bonus has times out. Hide the display and send <see cref="PinGodBase.BonusEndedEventHandler"/>
	/// </summary>
