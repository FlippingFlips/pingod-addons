...
namespace PinGod.Base
{
    public static class LongExtensions
    {
        ...
        /// <returns></returns>
        public static IEnumerable<string> CreateBonusZeroCountdown(this long totalBonus, bool formatScore = true)
        {
        ...
        public static Tuple<int, int> GetZeros(this long num)
        {
            int count = 0;
