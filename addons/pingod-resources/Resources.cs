...
public partial class Resources : Node
{
    ...
    [Export] Godot.Collections.Array<string> _resourcePacks 
        = new Godot.Collections.Array<string>() { "pingod.gfx.pck", "pingod.snd.pck" };

    [ExportCategory("Resources")]
    [Export]
    Godot.Collections.Dictionary<string, string> _resources = new();
    ...
    public override void _Ready()
    {
        ...
        {            
            ...
            {
                Logger.Info(nameof(Resources), ": Loading Resource Packs...");
                ...
                foreach (var resourcePack in _resourcePacks)
                {
                    ...
                    {
                        if(LoadResourcePack(System.IO.Path.Combine(WorkingDirectory, resourcePack)))
                            Logger.Debug(nameof(Resources), $": {resourcePack} - loaded");
                    }
                }
            ...
            Logger.Info(nameof(Resources), ": Loading Packed Scenes On Load?:", _loadPackedScenesOnLoad);
