...
public partial class MainScene : Node2D
{
	...
	/// </summary>
	[Export] protected string _service_menu_scene_path = "res://addons/pingod-game/Scenes/ServiceMenu.tscn";
	...
	public override void _EnterTree()
	{
		...
		pinGod?.Connect(nameof(PinGodGame.SwitchCommand), new Callable(this, nameof(OnSwitchCommandHandler)));
