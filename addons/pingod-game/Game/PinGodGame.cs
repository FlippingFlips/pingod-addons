...
public abstract partial class PinGodGame : PinGodBase
{
    ...
    private PinGodWindowActions pinGodWindowActions;
	...
	public override void _EnterTree()
	{
        if (!Engine.IsEditorHint())
        {
            ...
            if (this.HasNode($"/root/{nameof(PinGodWindowActions)}"))
            {
                pinGodWindowActions = GetNode<PinGodWindowActions>($"/root/{nameof(PinGodWindowActions)}");

                //pinGodWindowActions.Signals += OnPauseGame;
                //pinGodWindowActions.GameResumed += OnResumeGame;
            }
        }
    }
